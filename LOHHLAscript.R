...
option_list = list(
  ...
  make_option(c("--novoDir"), type="character", default='/software/novocraft',
  ...
  make_option(c("--picardDir"), type="character", default='/software/picard',
              help="path to Picard 2.25 executable [default= %default]", metavar="character"),
  make_option(c("--HLAexonLoc"), type="character", default='/software/LOHHLA/data/hla.dat',
  ...
  make_option(c("--jellyFish"), type="character", default='jellyfish',
              help="specify location of jellyfish binary [default= %default]", metavar="character"),
  make_option(c("--bedtools"), type="character", default='bedtools',
              help="specify location of bedtools binary [default= %default]", metavar="character"),
  ...
  make_option(c('--samtools'), type='character', default='samtools',
              help='specify location of samtools binary [default= %default]', metavar='character'),
